...
#printf "{\"Type\":1,\"Username\":\"$SCDTC_USERNAME\",\"Password\":\"$SCDTC_PASSWORD\",\"Integer_1\": true,\"HeartbeatIntervalInSeconds\": 6,\"ClientName\":\"test_shell\"}%b\x00\x00\x00\x00\x00\x00\x00\x00"
#printf '{\"Type\":1,\"Username\":\"$SCDTC_USERNAME\",\"Password\":\"$SCDTC_PASSWORD\",\"Integer_1\": 2,\"HeartbeatIntervalInSeconds\": 6,\"ClientName\":\"test_shell\"}%s\0'
#echo
#printf '%s\0' * \
